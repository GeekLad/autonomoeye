...
from autonomoeye.train import ProcessWaymoDataset 
...
def train(model, optimizer, lr_scheduler, train_dataloader, valid_dataloader, wandb_config):
    ...
    for epoch in range(wandb_config.num_epochs):
        ...
        torch.save(model.state_dict(), base_path +"/model_weights_{}.pth".format(epoch))
...
train_dataset = ProcessWaymoDataset('/content/drive/MyDrive/Colab_Notebooks/waymo/data/','train/annotations/2017-10-02/10793018113277660068_2714_540_2734_540.json',CATEGORY_NAMES, CATEGORY_IDS, RESIZE, AREA_LIMIT)

val_dataset = ProcessWaymoDataset('/content/drive/MyDrive/Colab_Notebooks/waymo/data/','validation/annotations/2017-10-01/17136314889476348164_979_560_999_560.json',CATEGORY_NAMES, CATEGORY_IDS, RESIZE, AREA_LIMIT)

train_dataloader = data.DataLoader(train_dataset, batch_size=4, collate_fn=collate_fn)
valid_dataloader = data.DataLoader(val_dataset, batch_size=4, collate_fn=collate_fn)
...
train(model, optimizer, lr_scheduler, train_dataloader, valid_dataloader, wandb_config)